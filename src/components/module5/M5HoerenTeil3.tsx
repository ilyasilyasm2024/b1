...
import { module5HoerenTeil3 } from "../../data/module5/hoerenTeil3";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "richtig" | "falsch" | null;
const SECTION_ID = "m5-hoeren-teil3";

export default function M5HoerenTeil3() {
  const data = module5HoerenTeil3;
