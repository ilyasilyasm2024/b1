...
import { module5LesenTeil5 } from "../../data/module5/lesenTeil5";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "a" | "b" | "c" | null;
const SECTION_ID = "m5-lesen-teil5";

export default function M5LesenTeil5() {
  const data = module5LesenTeil5;
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-sm text-gray-700 mb-6 italic">
        Sie lesen eine Informationsbrosch&uuml;re &uuml;ber das Citybike Wien, da Sie bald nach Wien fahren werden und ein begeisterter Radfahrer sind.
      </p>
