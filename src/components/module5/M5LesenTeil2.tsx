...
export default function M5LesenTeil2() {
  return (
    <div className="p-6">
      ...
      <LesenTeil2Section data={module5LesenTeil2A} sectionId="m5-lesen-teil2a" />
      ...
      <LesenTeil2Section data={module5LesenTeil2B} sectionId="m5-lesen-teil2b" />
    </div>
  );
}
