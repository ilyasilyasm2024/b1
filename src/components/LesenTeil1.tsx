...
export default function LesenTeil1() {
  ...
  return (
    <div className="p-6">
      ...
      {/* Text box - mimicking the bordered frame from the book */}
      ...
      <div className="mb-5">
        ...
        <div className="flex items-center justify-between border-b border-gray-300 pb-2">
          ...
          <div className="flex gap-1 shrink-0">
            <span className="border border-gray-400 px-3 py-0.5 text-xs rounded-sm text-gray-500">
              Richtig
            </span>
            <span className="border-2 border-black px-3 py-0.5 text-xs rounded-sm font-bold bg-gray-100">
              Falsch
            </span>
          </div>
        </div>
      ...
      {/* Questions - book style with bordered buttons */}
          ...
          return (
            ...
            >
              <p className="text-sm text-gray-800 flex-1 pr-4">
                <span className="inline-flex items-center justify-center w-5 h-5 bg-black text-white text-xs rounded-sm mr-2 font-bold">
                  {q.id}
                </span>
                {q.statement}
              </p>
