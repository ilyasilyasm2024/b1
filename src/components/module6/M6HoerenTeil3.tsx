...
import { module6HoerenTeil3 } from "../../data/module6/hoerenTeil3";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "richtig" | "falsch" | null;
const SECTION_ID = "m6-hoeren-teil3";

export default function M6HoerenTeil3() {
  const data = module6HoerenTeil3;
