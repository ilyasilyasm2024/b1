...
export default function M6LesenTeil2() {
  return (
    <div className="p-6">
      ...
      <LesenTeil2Section data={module6LesenTeil2A} sectionId="m6-lesen-teil2a" />
      ...
      <LesenTeil2Section data={module6LesenTeil2B} sectionId="m6-lesen-teil2b" />
    </div>
  );
}
