...
import { module6HoerenTeil1 } from "../../data/module6/hoerenTeil1";
...
const RF_SECTION = "m6-hoeren-teil1-rf";
const MC_SECTION = "m6-hoeren-teil1-mc";

export default function M6HoerenTeil1() {
  const data = module6HoerenTeil1;
