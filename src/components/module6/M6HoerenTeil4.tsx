...
import { module6HoerenTeil4 } from "../../data/module6/hoerenTeil4";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "moderatorin" | "leo" | "mario" | null;
const SECTION_ID = "m6-hoeren-teil4";

export default function M6HoerenTeil4() {
  const data = module6HoerenTeil4;
