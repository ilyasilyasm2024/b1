...
import { module6HoerenTeil2 } from "../../data/module6/hoerenTeil2";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "a" | "b" | "c" | null;
const SECTION_ID = "m6-hoeren-teil2";

export default function M6HoerenTeil2() {
  const data = module6HoerenTeil2;
