...
import M6LesenTeil1 from "./module6/M6LesenTeil1";
import M6LesenTeil2 from "./module6/M6LesenTeil2";
import M6LesenTeil3 from "./module6/M6LesenTeil3";
import M6LesenTeil4 from "./module6/M6LesenTeil4";
import M6LesenTeil5 from "./module6/M6LesenTeil5";
import M6HoerenTeil1 from "./module6/M6HoerenTeil1";
import M6HoerenTeil2 from "./module6/M6HoerenTeil2";
import M6HoerenTeil3 from "./module6/M6HoerenTeil3";
import M6HoerenTeil4 from "./module6/M6HoerenTeil4";
import M6Schreiben from "./module6/M6Schreiben";
import M6Sprechen from "./module6/M6Sprechen";
...
export default function Module6() {
  ...
  return (
    <div className="space-y-3">
      ...
      <Accordion
        title="Hören"
        icon={<svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M6.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z" /></svg>}
