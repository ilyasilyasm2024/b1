...
import { module7HoerenTeil1 } from "../../data/module7/hoerenTeil1";
...
const RF_SECTION = "m7-hoeren-teil1-rf";
const MC_SECTION = "m7-hoeren-teil1-mc";

export default function M7HoerenTeil1() {
  const data = module7HoerenTeil1;
