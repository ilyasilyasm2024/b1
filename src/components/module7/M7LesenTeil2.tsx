...
export default function M7LesenTeil2() {
  return (
    <div className="p-6">
      ...
      <LesenTeil2Section data={module7LesenTeil2A} sectionId="m7-lesen-teil2a" />
      ...
      <LesenTeil2Section data={module7LesenTeil2B} sectionId="m7-lesen-teil2b" />
    </div>
  );
}
