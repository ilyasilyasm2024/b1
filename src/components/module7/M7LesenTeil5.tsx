...
import { module7LesenTeil5 } from "../../data/module7/lesenTeil5";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "a" | "b" | "c" | null;
const SECTION_ID = "m7-lesen-teil5";

export default function M7LesenTeil5() {
  const data = module7LesenTeil5;
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-sm text-gray-700 mb-6 italic">
        Sie m&ouml;chten mit Ihrem Hund an Hundesportpr&uuml;fungen teilnehmen und lesen die Bestimmungen des VDH f&uuml;r die Begleithundpr&uuml;fung.
      </p>
