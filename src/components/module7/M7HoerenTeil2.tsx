...
import { module7HoerenTeil2 } from "../../data/module7/hoerenTeil2";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "a" | "b" | "c" | null;
const SECTION_ID = "m7-hoeren-teil2";

export default function M7HoerenTeil2() {
  const data = module7HoerenTeil2;
