...
import { module7HoerenTeil4 } from "../../data/module7/hoerenTeil4";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "journalistin" | "klein" | "grewe" | null;
const SECTION_ID = "m7-hoeren-teil4";

export default function M7HoerenTeil4() {
  const data = module7HoerenTeil4;
