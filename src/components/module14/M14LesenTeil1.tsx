...
import { module14LesenTeil1 } from "../../data/module14/lesenTeil1";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "richtig" | "falsch" | null;
const SECTION_ID = "m14-lesen-teil1";

export default function M14LesenTeil1() {
  const data = module14LesenTeil1;
