...
export default function M14LesenTeil2() {
  return (
    <div className="p-6">
      ...
      <LesenTeil2Section data={module14LesenTeil2A} sectionId="m14-lesen-teil2a" />
      ...
      <LesenTeil2Section data={module14LesenTeil2B} sectionId="m14-lesen-teil2b" />
    </div>
  );
}
