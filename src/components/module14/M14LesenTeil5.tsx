...
import { module14LesenTeil5 } from "../../data/module14/lesenTeil5";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "a" | "b" | "c" | null;
const SECTION_ID = "m14-lesen-teil5";

export default function M14LesenTeil5() {
  const data = module14LesenTeil5;
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-sm text-gray-700 mb-6 italic">
        Sie informieren sich &uuml;ber die Benutzungsordnung der Pestalozzi-Bibliothek Z&uuml;rich, da Sie bald f&uuml;r einige Zeit in Z&uuml;rich leben werden.
      </p>
