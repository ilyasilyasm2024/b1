...
import { module14HoerenTeil4 } from "../../data/module14/hoerenTeil4";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "moderatorin" | "lara" | "simon" | null;
const SECTION_ID = "m14-hoeren-teil4";

export default function M14HoerenTeil4() {
  const data = module14HoerenTeil4;
