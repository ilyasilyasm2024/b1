...
import { module14LesenTeil4 } from "../../data/module14/lesenTeil4";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "ja" | "nein" | null;
const SECTION_ID = "m14-lesen-teil4";

export default function M14LesenTeil4() {
  const data = module14LesenTeil4;
