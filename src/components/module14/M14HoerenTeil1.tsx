...
import { module14HoerenTeil1 } from "../../data/module14/hoerenTeil1";
...
const RF_SECTION = "m14-hoeren-teil1-rf";
const MC_SECTION = "m14-hoeren-teil1-mc";

export default function M14HoerenTeil1() {
  const data = module14HoerenTeil1;
