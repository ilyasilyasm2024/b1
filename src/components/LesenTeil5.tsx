  ...
  return (
    <div className="p-6">
      ...
      <p className="text-sm text-gray-700 mb-6 italic">
        Sie informieren sich über das {data.title}, weil sie es besuchen wollen.
      </p>

      {/* Questions - statement left, options right */}
      ...
      {/* Text - book style bordered box with 2-column layout */}
