...
import { module8HoerenTeil3 } from "../../data/module8/hoerenTeil3";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "richtig" | "falsch" | null;
const SECTION_ID = "m8-hoeren-teil3";

export default function M8HoerenTeil3() {
  const data = module8HoerenTeil3;
