...
import { module8HoerenTeil1 } from "../../data/module8/hoerenTeil1";
...
const RF_SECTION = "m8-hoeren-teil1-rf";
const MC_SECTION = "m8-hoeren-teil1-mc";

export default function M8HoerenTeil1() {
  const data = module8HoerenTeil1;
