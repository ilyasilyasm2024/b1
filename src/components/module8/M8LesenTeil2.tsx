...
export default function M8LesenTeil2() {
  return (
    <div className="p-6">
      ...
      <LesenTeil2Section data={module8LesenTeil2A} sectionId="m8-lesen-teil2a" />
      ...
      <LesenTeil2Section data={module8LesenTeil2B} sectionId="m8-lesen-teil2b" />
    </div>
  );
}
