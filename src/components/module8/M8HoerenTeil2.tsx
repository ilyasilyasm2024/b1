...
import { module8HoerenTeil2 } from "../../data/module8/hoerenTeil2";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "a" | "b" | "c" | null;
const SECTION_ID = "m8-hoeren-teil2";

export default function M8HoerenTeil2() {
  const data = module8HoerenTeil2;
