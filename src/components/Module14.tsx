...
import M14LesenTeil1 from "./module14/M14LesenTeil1";
import M14LesenTeil2 from "./module14/M14LesenTeil2";
import M14LesenTeil3 from "./module14/M14LesenTeil3";
import M14LesenTeil4 from "./module14/M14LesenTeil4";
import M14LesenTeil5 from "./module14/M14LesenTeil5";
import M14HoerenTeil1 from "./module14/M14HoerenTeil1";
import M14HoerenTeil2 from "./module14/M14HoerenTeil2";
import M14HoerenTeil3 from "./module14/M14HoerenTeil3";
import M14HoerenTeil4 from "./module14/M14HoerenTeil4";
import M14Schreiben from "./module14/M14Schreiben";
import M14Sprechen from "./module14/M14Sprechen";
...
export default function Module14() {
  ...
  return (
    <div className="space-y-3">
      ...
      <Accordion
        title="Hören"
        icon={<svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M14.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z" /></svg>}
      ...
      <Accordion
        title="Schreiben"
        icon={<svg className="w-5 h-5 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg>}
      ...
      <Accordion
        title="Sprechen"
        icon={<svg className="w-5 h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 12h.01M14 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>}
