...
import { module2LesenTeil3 } from "../../data/module2/lesenTeil3";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

const SECTION_ID = "m2-lesen-teil3";

export default function M2LesenTeil3() {
  const data = module2LesenTeil3;
