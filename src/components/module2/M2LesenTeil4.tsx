...
import { module2LesenTeil4 } from "../../data/module2/lesenTeil4";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "ja" | "nein" | null;
const SECTION_ID = "m2-lesen-teil4";

export default function M2LesenTeil4() {
  const data = module2LesenTeil4;
  ...
  return (
    <div className="p-6">
      ...
      {/* Names grid with Ja/Nein buttons */}
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="border-2 border-black px-2 py-0.5 text-[10px] rounded-sm font-bold bg-gray-100">Ja</span>
          <span className="border border-gray-400 px-2 py-0.5 text-[10px] rounded-sm text-gray-500">Nein</span>
        </div>
