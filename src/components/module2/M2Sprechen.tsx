...
import { module2Sprechen } from "../../data/module2/sprechen";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

const SECTION_ID = "m2-sprechen";

export default function M2Sprechen() {
  const data = module2Sprechen;
  const { updateProgress } = useProgress();
  const { getAnswers, setAnswers } = useAnswers();
  const [activeTab, setActiveTab] = useState<"teil1" | "teil2a" | "teil2b" | "teil3">("teil1");

  // Store notes for each section
  const NOTE_KEYS = [
    "teil1",
    "teil2a-0",
    "teil2a-1",
  ...
  useEffect(() => {
    ...
    // Total sections: teil1 + teil2a (5 folien) + teil2b (5 folien) + teil3 = 12 possible
