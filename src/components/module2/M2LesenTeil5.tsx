...
import { module2LesenTeil5 } from "../../data/module2/lesenTeil5";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "a" | "b" | "c" | null;
const SECTION_ID = "m2-lesen-teil5";

export default function M2LesenTeil5() {
  const data = module2LesenTeil5;
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-sm text-gray-700 mb-6 italic">
        Sie informieren sich über den {data.title}, weil Sie es besuchen wollen.
      </p>
