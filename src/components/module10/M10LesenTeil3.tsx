...
import { module10LesenTeil3 } from "../../data/module10/lesenTeil3";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

const SECTION_ID = "m10-lesen-teil3";

export default function M10LesenTeil3() {
  const data = module10LesenTeil3;
