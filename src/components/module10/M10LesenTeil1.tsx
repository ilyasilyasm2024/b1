...
import { module10LesenTeil1 } from "../../data/module10/lesenTeil1";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "richtig" | "falsch" | null;
const SECTION_ID = "m10-lesen-teil1";

export default function M10LesenTeil1() {
  const data = module10LesenTeil1;
