...
import { module10LesenTeil4 } from "../../data/module10/lesenTeil4";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "ja" | "nein" | null;
const SECTION_ID = "m10-lesen-teil4";

export default function M10LesenTeil4() {
  const data = module10LesenTeil4;
