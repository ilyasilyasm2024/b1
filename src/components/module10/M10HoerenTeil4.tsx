...
import { module10HoerenTeil4 } from "../../data/module10/hoerenTeil4";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "journalistin" | "fink" | "egger" | null;
const SECTION_ID = "m10-hoeren-teil4";

export default function M10HoerenTeil4() {
  const data = module10HoerenTeil4;
