...
import { module10HoerenTeil3 } from "../../data/module10/hoerenTeil3";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "richtig" | "falsch" | null;
const SECTION_ID = "m10-hoeren-teil3";

export default function M10HoerenTeil3() {
  const data = module10HoerenTeil3;
