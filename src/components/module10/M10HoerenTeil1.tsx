...
import { module10HoerenTeil1 } from "../../data/module10/hoerenTeil1";
...
const RF_SECTION = "m10-hoeren-teil1-rf";
const MC_SECTION = "m10-hoeren-teil1-mc";

export default function M10HoerenTeil1() {
  const data = module10HoerenTeil1;
