...
export default function M10LesenTeil2() {
  return (
    <div className="p-6">
      ...
      <LesenTeil2Section data={module10LesenTeil2A} sectionId="m10-lesen-teil2a" />
      ...
      <LesenTeil2Section data={module10LesenTeil2B} sectionId="m10-lesen-teil2b" />
    </div>
  );
}
