...
import { module10LesenTeil5 } from "../../data/module10/lesenTeil5";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "a" | "b" | "c" | null;
const SECTION_ID = "m10-lesen-teil5";

export default function M10LesenTeil5() {
  const data = module10LesenTeil5;
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-sm text-gray-700 mb-6 italic">
        Sie interessieren sich f&uuml;r den Freiwilligendienst und informieren sich &uuml;ber die Aktivit&auml;ten des SCI.
      </p>
