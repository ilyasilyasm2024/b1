...
import M7LesenTeil1 from "./module7/M7LesenTeil1";
import M7LesenTeil2 from "./module7/M7LesenTeil2";
import M7LesenTeil3 from "./module7/M7LesenTeil3";
import M7LesenTeil4 from "./module7/M7LesenTeil4";
import M7LesenTeil5 from "./module7/M7LesenTeil5";
import M7HoerenTeil1 from "./module7/M7HoerenTeil1";
import M7HoerenTeil2 from "./module7/M7HoerenTeil2";
import M7HoerenTeil3 from "./module7/M7HoerenTeil3";
import M7HoerenTeil4 from "./module7/M7HoerenTeil4";
import M7Schreiben from "./module7/M7Schreiben";
import M7Sprechen from "./module7/M7Sprechen";
...
export default function Module7() {
  ...
  return (
    <div className="space-y-3">
      ...
      <Accordion
        title="Hören"
        icon={<svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M7.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z" /></svg>}
