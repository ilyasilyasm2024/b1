    ...
    <div className="mb-8">
      <div className="border border-gray-400 bg-white mb-5 shadow-sm">
        ...
        <div className="px-5 pb-2 text-right border-t border-gray-100">
          <p className="text-[10px] italic text-gray-500">aus einer Schweizer Zeitung</p>
        </div>
      </div>
...
export default function M15LesenTeil2() {
  return (
    <div className="p-6">
      ...
      <LesenTeil2Section data={module15LesenTeil2A} sectionId="m15-lesen-teil2a" />
      ...
      <LesenTeil2Section data={module15LesenTeil2B} sectionId="m15-lesen-teil2b" />
    </div>
  );
}
