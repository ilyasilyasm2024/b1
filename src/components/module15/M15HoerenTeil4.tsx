...
import { module15HoerenTeil4 } from "../../data/module15/hoerenTeil4";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "moderator" | "annette" | "michael" | null;
const SECTION_ID = "m15-hoeren-teil4";

export default function M15HoerenTeil4() {
  const data = module15HoerenTeil4;
