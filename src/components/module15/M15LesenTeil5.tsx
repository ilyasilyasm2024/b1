...
import { module15LesenTeil5 } from "../../data/module15/lesenTeil5";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "a" | "b" | "c" | null;
const SECTION_ID = "m15-lesen-teil5";

export default function M15LesenTeil5() {
  const data = module15LesenTeil5;
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-sm text-gray-700 mb-6 italic">
        Sie informieren sich &uuml;ber die Anmeldeinformationen der SommerKinderUni Graz, weil Sie im Programm der Universit&auml;t interessante Angebote gefunden haben.
      </p>
