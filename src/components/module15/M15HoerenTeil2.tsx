...
import { module15HoerenTeil2 } from "../../data/module15/hoerenTeil2";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "a" | "b" | "c" | null;
const SECTION_ID = "m15-hoeren-teil2";

export default function M15HoerenTeil2() {
  const data = module15HoerenTeil2;
