...
import { module3HoerenTeil3 } from "../../data/module3/hoerenTeil3";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "richtig" | "falsch" | null;
const SECTION_ID = "m3-hoeren-teil3";

export default function M3HoerenTeil3() {
  const data = module3HoerenTeil3;
