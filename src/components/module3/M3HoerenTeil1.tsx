...
import { module3HoerenTeil1 } from "../../data/module3/hoerenTeil1";
...
const RF_SECTION = "m3-hoeren-teil1-rf";
const MC_SECTION = "m3-hoeren-teil1-mc";

export default function M3HoerenTeil1() {
  const data = module3HoerenTeil1;
