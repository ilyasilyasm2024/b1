...
import { module3HoerenTeil2 } from "../../data/module3/hoerenTeil2";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "a" | "b" | "c" | null;
const SECTION_ID = "m3-hoeren-teil2";

export default function M3HoerenTeil2() {
  const data = module3HoerenTeil2;
