...
export default function M3LesenTeil2() {
  return (
    <div className="p-6">
      ...
      <LesenTeil2Section data={module3LesenTeil2A} sectionId="m3-lesen-teil2a" />
      ...
      <LesenTeil2Section data={module3LesenTeil2B} sectionId="m3-lesen-teil2b" />
    </div>
  );
}
