...
import { module3HoerenTeil4 } from "../../data/module3/hoerenTeil4";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "journalist" | "anna" | "kim" | null;
const SECTION_ID = "m3-hoeren-teil4";

export default function M3HoerenTeil4() {
  const data = module3HoerenTeil4;
