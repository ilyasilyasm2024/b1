...
import { module11HoerenTeil3 } from "../../data/module11/hoerenTeil3";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "richtig" | "falsch" | null;
const SECTION_ID = "m11-hoeren-teil3";

export default function M11HoerenTeil3() {
  const data = module11HoerenTeil3;
