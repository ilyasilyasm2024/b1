...
export default function M11LesenTeil2() {
  return (
    <div className="p-6">
      ...
      <LesenTeil2Section data={module11LesenTeil2A} sectionId="m11-lesen-teil2a" />
      ...
      <LesenTeil2Section data={module11LesenTeil2B} sectionId="m11-lesen-teil2b" />
    </div>
  );
}
