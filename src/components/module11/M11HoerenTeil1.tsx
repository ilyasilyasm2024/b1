...
import { module11HoerenTeil1 } from "../../data/module11/hoerenTeil1";
...
const RF_SECTION = "m11-hoeren-teil1-rf";
const MC_SECTION = "m11-hoeren-teil1-mc";

export default function M11HoerenTeil1() {
  const data = module11HoerenTeil1;
