...
import { module11LesenTeil4 } from "../../data/module11/lesenTeil4";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "ja" | "nein" | null;
const SECTION_ID = "m11-lesen-teil4";

export default function M11LesenTeil4() {
  const data = module11LesenTeil4;
