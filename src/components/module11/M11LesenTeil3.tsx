...
import { module11LesenTeil3 } from "../../data/module11/lesenTeil3";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

const SECTION_ID = "m11-lesen-teil3";

export default function M11LesenTeil3() {
  const data = module11LesenTeil3;
