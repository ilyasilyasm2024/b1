...
import { module11LesenTeil5 } from "../../data/module11/lesenTeil5";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "a" | "b" | "c" | null;
const SECTION_ID = "m11-lesen-teil5";

export default function M11LesenTeil5() {
  const data = module11LesenTeil5;
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-sm text-gray-700 mb-6 italic">
        Da Sie an einer Sprachpr&uuml;fung teilnehmen wollen, lesen Sie die Pr&uuml;fungsordnung.
      </p>
