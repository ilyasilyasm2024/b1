...
const SECTION_ID = "m1-lesen-teil1";

export default function LesenTeil1() {
  const data = module1LesenTeil1;
  ...
  return (
    <div className="p-6">
      ...
      <div className="border border-gray-400 p-5 mb-6 bg-white shadow-sm">
        ...
        <p className="text-[11px] text-gray-900 leading-[1.7] text-justify hyphens-auto">
          {data.text}
        </p>
      </div>
      ...
      <div className="mb-5">
        ...
        <div className="flex items-center justify-between border-b border-gray-300 pb-2">
          ...
          <div className="flex gap-1 shrink-0">
            <span className="border border-gray-400 px-3 py-0.5 text-xs rounded-sm text-gray-500">Richtig</span>
            <span className="border-2 border-black px-3 py-0.5 text-xs rounded-sm font-bold bg-gray-100">Falsch</span>
          </div>
        </div>
      </div>
            ...
            >
              ...
              <div className="flex gap-1 shrink-0">
                <button
                  ...
                  disabled={submitted}
                  className={`border px-3 py-0.5 text-xs rounded-sm cursor-pointer transition-colors ${
                    userAnswer === "richtig" ? "border-2 border-black bg-gray-100 font-bold" : "border-gray-400 text-gray-600 hover:border-gray-600"
                  }`}
                >
                  Richtig
                </button>
                <button
                  ...
                  disabled={submitted}
                  className={`border px-3 py-0.5 text-xs rounded-sm cursor-pointer transition-colors ${
                    userAnswer === "falsch" ? "border-2 border-black bg-gray-100 font-bold" : "border-gray-400 text-gray-600 hover:border-gray-600"
                  }`}
                >
                  Falsch
                </button>
