...
import { module4LesenTeil5 } from "../../data/module4/lesenTeil5";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "a" | "b" | "c" | null;
const SECTION_ID = "m4-lesen-teil5";

export default function M4LesenTeil5() {
  const data = module4LesenTeil5;
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-sm text-gray-700 mb-6 italic">
        Sie m&ouml;chten auf einem Campingplatz &uuml;bernachten und informieren sich &uuml;ber die Nutzungsordnung.
      </p>
