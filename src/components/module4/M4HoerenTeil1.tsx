...
import { module4HoerenTeil1 } from "../../data/module4/hoerenTeil1";
...
const RF_SECTION = "m4-hoeren-teil1-rf";
const MC_SECTION = "m4-hoeren-teil1-mc";

export default function M4HoerenTeil1() {
  const data = module4HoerenTeil1;
