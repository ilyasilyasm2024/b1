...
import { module4HoerenTeil4 } from "../../data/module4/hoerenTeil4";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "moderator" | "doris" | "eva" | null;
const SECTION_ID = "m4-hoeren-teil4";

export default function M4HoerenTeil4() {
  const data = module4HoerenTeil4;
