...
import { module4HoerenTeil2 } from "../../data/module4/hoerenTeil2";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "a" | "b" | "c" | null;
const SECTION_ID = "m4-hoeren-teil2";

export default function M4HoerenTeil2() {
  const data = module4HoerenTeil2;
