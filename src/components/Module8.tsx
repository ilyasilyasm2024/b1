...
import M8LesenTeil1 from "./module8/M8LesenTeil1";
import M8LesenTeil2 from "./module8/M8LesenTeil2";
import M8LesenTeil3 from "./module8/M8LesenTeil3";
import M8LesenTeil4 from "./module8/M8LesenTeil4";
import M8LesenTeil5 from "./module8/M8LesenTeil5";
import M8HoerenTeil1 from "./module8/M8HoerenTeil1";
import M8HoerenTeil2 from "./module8/M8HoerenTeil2";
import M8HoerenTeil3 from "./module8/M8HoerenTeil3";
import M8HoerenTeil4 from "./module8/M8HoerenTeil4";
import M8Schreiben from "./module8/M8Schreiben";
import M8Sprechen from "./module8/M8Sprechen";
...
export default function Module8() {
  ...
  return (
    <div className="space-y-3">
      ...
      <Accordion
        title="Hören"
        icon={<svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M8.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z" /></svg>}
