...
import { module9HoerenTeil4 } from "../../data/module9/hoerenTeil4";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "moderator" | "steiner" | "gerber" | null;
const SECTION_ID = "m9-hoeren-teil4";

export default function M9HoerenTeil4() {
  const data = module9HoerenTeil4;
