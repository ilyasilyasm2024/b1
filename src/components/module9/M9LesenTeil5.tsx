...
import { module9LesenTeil5 } from "../../data/module9/lesenTeil5";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "a" | "b" | "c" | null;
const SECTION_ID = "m9-lesen-teil5";

export default function M9LesenTeil5() {
  const data = module9LesenTeil5;
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-sm text-gray-700 mb-6 italic">
        Sie m&ouml;chten im CORPUS Fitness Studio trainieren und lesen die Benutzungsordnung.
      </p>
