...
export default function M9LesenTeil2() {
  return (
    <div className="p-6">
      ...
      <LesenTeil2Section data={module9LesenTeil2A} sectionId="m9-lesen-teil2a" />
      ...
      <LesenTeil2Section data={module9LesenTeil2B} sectionId="m9-lesen-teil2b" />
    </div>
  );
}
