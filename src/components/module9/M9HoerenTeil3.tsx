...
import { module9HoerenTeil3 } from "../../data/module9/hoerenTeil3";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "richtig" | "falsch" | null;
const SECTION_ID = "m9-hoeren-teil3";

export default function M9HoerenTeil3() {
  const data = module9HoerenTeil3;
