...
import { module9HoerenTeil1 } from "../../data/module9/hoerenTeil1";
...
const RF_SECTION = "m9-hoeren-teil1-rf";
const MC_SECTION = "m9-hoeren-teil1-mc";

export default function M9HoerenTeil1() {
  const data = module9HoerenTeil1;
