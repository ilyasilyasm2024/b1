...
import { module12HoerenTeil4 } from "../../data/module12/hoerenTeil4";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "moderator" | "flavia" | "christina" | null;
const SECTION_ID = "m12-hoeren-teil4";

export default function M12HoerenTeil4() {
  const data = module12HoerenTeil4;
