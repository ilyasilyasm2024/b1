...
import { module12LesenTeil5 } from "../../data/module12/lesenTeil5";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "a" | "b" | "c" | null;
const SECTION_ID = "m12-lesen-teil5";

export default function M12LesenTeil5() {
  const data = module12LesenTeil5;
  ...
  return (
    <div className="p-6">
      ...
      <p className="text-sm text-gray-700 mb-6 italic">
        Sie informieren sich &uuml;ber die Garantieleistungen und -bedingungen f&uuml;r einen PC, den Sie gekauft haben.
      </p>
