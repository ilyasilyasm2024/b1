...
import { module12LesenTeil3 } from "../../data/module12/lesenTeil3";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

const SECTION_ID = "m12-lesen-teil3";

export default function M12LesenTeil3() {
  const data = module12LesenTeil3;
