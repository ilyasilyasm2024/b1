...
import { module12HoerenTeil3 } from "../../data/module12/hoerenTeil3";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "richtig" | "falsch" | null;
const SECTION_ID = "m12-hoeren-teil3";

export default function M12HoerenTeil3() {
  const data = module12HoerenTeil3;
