...
import { module12LesenTeil4 } from "../../data/module12/lesenTeil4";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "ja" | "nein" | null;
const SECTION_ID = "m12-lesen-teil4";

export default function M12LesenTeil4() {
  const data = module12LesenTeil4;
