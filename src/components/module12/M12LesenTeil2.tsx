...
export default function M12LesenTeil2() {
  return (
    <div className="p-6">
      ...
      <LesenTeil2Section data={module12LesenTeil2A} sectionId="m12-lesen-teil2a" />
      ...
      <LesenTeil2Section data={module12LesenTeil2B} sectionId="m12-lesen-teil2b" />
    </div>
  );
}
