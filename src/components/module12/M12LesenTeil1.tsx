...
import { module12LesenTeil1 } from "../../data/module12/lesenTeil1";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "richtig" | "falsch" | null;
const SECTION_ID = "m12-lesen-teil1";

export default function M12LesenTeil1() {
  const data = module12LesenTeil1;
