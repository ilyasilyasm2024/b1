...
import { module12HoerenTeil2 } from "../../data/module12/hoerenTeil2";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "a" | "b" | "c" | null;
const SECTION_ID = "m12-hoeren-teil2";

export default function M12HoerenTeil2() {
  const data = module12HoerenTeil2;
