...
import { module12HoerenTeil1 } from "../../data/module12/hoerenTeil1";
...
const RF_SECTION = "m12-hoeren-teil1-rf";
const MC_SECTION = "m12-hoeren-teil1-mc";

export default function M12HoerenTeil1() {
  const data = module12HoerenTeil1;
