...
import M12LesenTeil1 from "./module12/M12LesenTeil1";
import M12LesenTeil2 from "./module12/M12LesenTeil2";
import M12LesenTeil3 from "./module12/M12LesenTeil3";
import M12LesenTeil4 from "./module12/M12LesenTeil4";
import M12LesenTeil5 from "./module12/M12LesenTeil5";
import M12HoerenTeil1 from "./module12/M12HoerenTeil1";
import M12HoerenTeil2 from "./module12/M12HoerenTeil2";
import M12HoerenTeil3 from "./module12/M12HoerenTeil3";
import M12HoerenTeil4 from "./module12/M12HoerenTeil4";
import M12Schreiben from "./module12/M12Schreiben";
import M12Sprechen from "./module12/M12Sprechen";
...
export default function Module12() {
  ...
  return (
    <div className="space-y-3">
      ...
      <Accordion
        title="Hören"
        icon={<svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M12.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z" /></svg>}
      ...
      <Accordion
        title="Sprechen"
        icon={<svg className="w-5 h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" /></svg>}
