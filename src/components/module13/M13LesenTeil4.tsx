...
import { module13LesenTeil4 } from "../../data/module13/lesenTeil4";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "ja" | "nein" | null;
const SECTION_ID = "m13-lesen-teil4";

export default function M13LesenTeil4() {
  const data = module13LesenTeil4;
