...
import { module13HoerenTeil1 } from "../../data/module13/hoerenTeil1";
...
const RF_SECTION = "m13-hoeren-teil1-rf";
const MC_SECTION = "m13-hoeren-teil1-mc";

export default function M13HoerenTeil1() {
  const data = module13HoerenTeil1;
