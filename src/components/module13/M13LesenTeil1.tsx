...
import { module13LesenTeil1 } from "../../data/module13/lesenTeil1";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "richtig" | "falsch" | null;
const SECTION_ID = "m13-lesen-teil1";

export default function M13LesenTeil1() {
  const data = module13LesenTeil1;
