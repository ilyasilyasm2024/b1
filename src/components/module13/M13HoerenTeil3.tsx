...
import { module13HoerenTeil3 } from "../../data/module13/hoerenTeil3";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "richtig" | "falsch" | null;
const SECTION_ID = "m13-hoeren-teil3";

export default function M13HoerenTeil3() {
  const data = module13HoerenTeil3;
