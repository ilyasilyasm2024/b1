...
import { module13HoerenTeil4 } from "../../data/module13/hoerenTeil4";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "moderator" | "schulz" | "tilmann" | null;
const SECTION_ID = "m13-hoeren-teil4";

export default function M13HoerenTeil4() {
  const data = module13HoerenTeil4;
