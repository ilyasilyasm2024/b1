...
import { module13LesenTeil3 } from "../../data/module13/lesenTeil3";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

const SECTION_ID = "m13-lesen-teil3";

export default function M13LesenTeil3() {
  const data = module13LesenTeil3;
