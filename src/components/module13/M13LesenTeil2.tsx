...
export default function M13LesenTeil2() {
  return (
    <div className="p-6">
      ...
      <LesenTeil2Section data={module13LesenTeil2A} sectionId="m13-lesen-teil2a" />
      ...
      <LesenTeil2Section data={module13LesenTeil2B} sectionId="m13-lesen-teil2b" />
    </div>
  );
}
