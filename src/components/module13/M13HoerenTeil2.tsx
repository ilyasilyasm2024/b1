...
import { module13HoerenTeil2 } from "../../data/module13/hoerenTeil2";
import { useProgress } from "../../context/ProgressContext";
import { useAnswers } from "../../context/AnswersContext";

type Answer = "a" | "b" | "c" | null;
const SECTION_ID = "m13-hoeren-teil2";

export default function M13HoerenTeil2() {
  const data = module13HoerenTeil2;
