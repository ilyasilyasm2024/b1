...
export const module11Sprechen: SprechenData = {
  module: 11,
  part: "Sprechen",
  teil1: {
    title: "Teil 1 \u2013 Gemeinsam etwas planen",
    instruction:
      "Ihre Oma m\u00f6chte sich einen Computer anschaffen. Da sie von Technik nichts versteht, hat sie Sie gebeten, einen PC f\u00fcr sie zu kaufen. \u00dcberlegen Sie, wie Sie ihr helfen k\u00f6nnen. Sprechen Sie \u00fcber die Punkte unten, machen Sie Vorschl\u00e4ge und reagieren Sie auf die Vorschl\u00e4ge Ihres Gespr\u00e4chspartners / Ihrer Gespr\u00e4chspartnerin. Planen und entscheiden Sie gemeinsam, was Sie tun m\u00f6chten.",
    topic: "PC kaufen",
    points: [
      "Informationen? (Wo?)",
      "Wo kaufen?",
  ...
  teil2A: {
    ...
    topic: "Museen mit Geh\u00f6rlosen \u2013 freier Eintritt?",
    folien: [
      {
        step: "Stellen Sie Ihr Thema vor. Erkl\u00e4ren Sie den Inhalt und die Struktur Ihrer Pr\u00e4sentation.",
        content: "Sollten Museen freien Eintritt anbieten?",
      },
      {
      ...
      },
      {
        ...
        content: "MUSEEN IN MEINEM HEIMATLAND",
      },
      {
  ...
  teil2B: {
    ...
    instruction:
      "Sie sollen Ihren Zuh\u00f6rern ein aktuelles Thema pr\u00e4sentieren. Dazu finden Sie hier f\u00fcnf Folien. Folgen Sie den Anweisungen links und schreiben Sie Ihre Notizen und Ideen rechts daneben.",
    topic: "\u00c4ltere Leute im Altersheim?",
    folien: [
      {
        step: "Stellen Sie Ihr Thema vor. Erkl\u00e4ren Sie den Inhalt und die Struktur Ihrer Pr\u00e4sentation.",
        content: "Sollten \u00e4ltere Leute im Altersheim wohnen?",
      },
      {
        step: "Berichten Sie von Ihrer Situation oder einem Erlebnis im Zusammenhang mit dem Thema.",
        content: "MEINE PERS\u00d6NLICHEN ERFAHRUNGEN",
      ...
      {
        step: "Berichten Sie von der Situation in Ihrem Heimatland und geben Sie Beispiele.",
        content: "WO LEBEN \u00c4LTERE LEUTE IN MEINEM HEIMATLAND",
      },
      {
        step: "Nennen Sie die Vor- und Nachteile und sagen Sie dazu Ihre Meinung. Geben Sie auch Beispiele.",
        content: "VOR- UND NACHTEILE DES WOHNENS IM ALTER & MEINE MEINUNG",
      },
      {
        step: "Beenden Sie Ihre Pr\u00e4sentation und bedanken Sie sich bei den Zuh\u00f6rern.",
        content: "ABSCHLUSS & DANK",
