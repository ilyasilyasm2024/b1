...
export const module14Sprechen: SprechenData = {
  module: 14,
  part: "Sprechen",
  teil1: {
    title: "Teil 1 \u2013 Gemeinsam etwas planen",
    instruction:
      "Sie m\u00f6chten mit Ihren Freunden einen Radausflug in die Umgebung machen. Dazu m\u00fcssen Sie pr\u00fcfen, ob Ihre Fahrr\u00e4der in Ordnung sind. \u00dcberlegen Sie auch, was Sie vorher alles planen m\u00fcssen. Sprechen Sie \u00fcber die Punkte unten, machen Sie Vorschl\u00e4ge und reagieren Sie auf die Vorschl\u00e4ge Ihres Gespr\u00e4chspartners / Ihrer Gespr\u00e4chspartnerin. Planen und entscheiden Sie gemeinsam, was Sie tun m\u00f6chten.",
    topic: "Planung des Ausflugs und Kontrolle der Fahrr\u00e4der",
    points: [
      "Wohin fahren?",
  ...
  teil2A: {
    ...
    folien: [
      ...
      },
      {
        ...
        content: "PLASTIKGESCHIRR IN MEINEM HEIMATLAND",
      },
      {
