...
export const module7Sprechen: SprechenData = {
  module: 7,
  part: "Sprechen",
  teil1: {
    title: "Teil 1 \u2013 Gemeinsam etwas planen",
    instruction:
      "Ihre Klasse hat beschlossen, den Klassenraum zu versch\u00f6nern. Zuerst m\u00f6chten Sie Ideen sammeln, wie Sie das am besten machen k\u00f6nnen. Sprechen Sie \u00fcber die Punkte unten, machen Sie Vorschl\u00e4ge und reagieren Sie auf die Vorschl\u00e4ge Ihres Gespr\u00e4chspartners / Ihrer Gespr\u00e4chspartnerin. Planen und entscheiden Sie gemeinsam, was Sie tun m\u00f6chten.",
    topic: "Klassenraum versch\u00f6nern",
    points: [
      "Wer mitmachen?",
      "Was machen?",
      "Wann?",
  ...
  teil2A: {
    ...
    topic: "Sollte man in der Schule mehr Fremdsprachen lernen?",
    folien: [
      {
        step: "Stellen Sie Ihr Thema vor. Erkl\u00e4ren Sie den Inhalt und die Struktur Ihrer Pr\u00e4sentation.",
        content: "Sollte man in der Schule mehr Fremdsprachen lernen?",
      },
      {
      ...
      },
      {
        ...
        content: "DIE ROLLE VON FREMDSPRACHEN IN MEINEM HEIMATLAND",
      },
      {
  ...
  teil2B: {
    ...
    instruction:
      "Sie sollen Ihren Zuh\u00f6rern ein aktuelles Thema pr\u00e4sentieren. Dazu finden Sie hier f\u00fcnf Folien. Folgen Sie den Anweisungen links und schreiben Sie Ihre Notizen und Ideen rechts daneben.",
    topic: "Kaufen oder mieten?",
    folien: [
      {
        step: "Stellen Sie Ihr Thema vor. Erkl\u00e4ren Sie den Inhalt und die Struktur Ihrer Pr\u00e4sentation.",
        content: "Kaufen oder mieten?",
      },
      {
        step: "Berichten Sie von Ihrer Situation oder einem Erlebnis im Zusammenhang mit dem Thema.",
        content: "MEINE PERS\u00d6NLICHEN ERFAHRUNGEN",
      ...
      {
        step: "Berichten Sie von der Situation in Ihrem Heimatland und geben Sie Beispiele.",
        content: "WOHNEN IN MEINEM HEIMATLAND",
      },
      {
        step: "Nennen Sie die Vor- und Nachteile und sagen Sie dazu Ihre Meinung. Geben Sie auch Beispiele.",
        content: "VOR- UND NACHTEILE & MEINE MEINUNG",
